...
// We will use member variables, instead of local variables, to store the data
    ...
    private void addKey() {
        ...
        int xRec=10; int yRec = 10;
        int widthRec = 150;
        int hightRec =300;
        fill(255,255,255);
        rect(xRec,yRec,widthRec,hightRec);
     //   stroke(51,51,255);
       fill(0,0,204);
        textSize(14);
        text("Earthquake Key",40,30,7);
        line(20,40,150,40);
        //City Marker
      //  fill(135,0,0);
        fill(0,255,0);
        //draw Triangle x,y,width,height,x3,y3.
        triangle(20,70,30,50,40,70);
        fill(0,0,0);
        textSize(12);
        text("City Marker",50,65,8);
        //draw  Land Quake.
        fill(255,255,255);
        stroke(0,0,0);
        ellipse(32,85,15,15);
        ...
        fill(0,0,0);
        textSize(12);
        text("Ocean Quake",45,113,8);
        fill(0,0,0);
        textSize(14);
        text("Size ~ magnitude ",30,150,8);
        /**draw magnitude Earthquake.
         *  Low Magnitude >> color:yellow.
         * Average Magnitude>> color:blue.
         * Hight Magnitude >> color:red.
         */
        //Low Magnitude.
        fill(255,255,0);
        stroke(0,0,0);
        ellipse(32,170,15,15);
        //Average Magnitude
        fill(0,0,255);
        stroke(0,0,0);
        ellipse(32,200,15,15);
        // Hight Magnitude
        fill(255,0,0);
        stroke(0,0,0);
        ellipse(32,230,15,15);
        //Past hour
        fill(255,255,255);
       stroke(0,0,0);
        ellipse(32,260,15,15);
        int xbase = 25;
        int ybase = 50;
        int centerx = xbase+8;
        ...
        fill(0,0,0);
        textSize(12);
        text("Shallow",50,175,7);
        text("Intermediate",50,205,7);
        text("Deep",50,235,7);
        text("Past Hour",50,265,7);
    }

    //This method determint if earthquake occure is on land return true overthise return false.
