...
public class HelloWorld extends PApplet {
    ...
    public void setup() {
        size(800, 600,JAVA2D);  // Set up the Applet window to be 800x600
        ...
        map2 =new UnfoldingMap(this, 550, 350, 300, 500, provider);

        // The next line zooms in and centers the map at
        // 32.9 (latitude) and -117.2 (longitude)
        map1.zoomAndPanTo(zoomLevel, new Location(32.9f, -117.2f));
        map2.zoomAndPanTo(zoomLevel,new Location(30.007443,32.484263));
